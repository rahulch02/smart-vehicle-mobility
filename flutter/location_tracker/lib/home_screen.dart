  ...
  void hearCollisions() {
    collision = usersRef.snapshots().listen((event) {
      ...
      event.docs.forEach((element) {
        double lat1 = curUser.latitude * pi / 180;
        double lon1 = curUser.longitude * pi / 180;
        double lat2 = element['latitude'] * pi / 180;
        double lon2 = element['longitude'] * pi / 180;
        ...
        double a = (sin(dlat / 2) * sin(dlat / 2)) +
            cos(curUser.latitude) *
                cos(element['latitude']) *
                (sin(dlon / 2) * sin(dlon / 2));
        double c = 2 * atan2(sqrt(a), 1 - sqrt(a));

        double dist = 1000 * R * c;
